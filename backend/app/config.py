...
class Settings:
    ...
    NTFY_TOPIC_NORMAL = _env_str("NTFY_TOPIC_NORMAL", "kaosgdd")
    NTFY_TOPIC_URGENT = _env_str("NTFY_TOPIC_URGENT", "kaosgdd-urgent")
    NTFY_TOPIC_SYSTEM = _env_str("NTFY_TOPIC_SYSTEM", "kaosgdd-urgent")
