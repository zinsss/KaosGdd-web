...
${compactCss}`;
  ...
  assert.match(compactCss, /\.familyCalendarWeekEditingSelected\s*\{[\s\S]*?border-color:\s*rgba\(180, 120, 190, 0\.36\);[\s\S]*?background:\s*rgba\(230, 220, 255, 0\.22\);[\s\S]*?box-shadow:\s*inset 0 0 0 1px rgba\(180, 120, 190, 0\.1\);/);
