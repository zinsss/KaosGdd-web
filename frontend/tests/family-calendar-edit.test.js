...
${compactCss}`;
  ...
  assert.ok(compactCss.includes("padding: 8px 0 6px;"));
  assert.ok(compactCss.includes("inset 2px 0 0 rgba(214, 128, 157, 0.26)"));
  assert.ok(compactCss.includes("background: #fffafd;"));
  assert.ok(compactCss.includes("inset 2px 0 0 rgba(180, 120, 190, 0.4)"));
